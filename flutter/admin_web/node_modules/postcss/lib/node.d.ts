...
declare abstract class Node_ {
   ...
   * * `left`: the space symbols between `/*` and the comment鈥檚 text.
   * * `right`: the space symbols between the comment鈥檚 text
   *   and <code>*&#47;</code>.
  ...
  /**
   * Insert new node after current node to current node鈥檚 parent.
   *
  ...
  /**
   * Insert new node before current node to current node鈥檚 parent.
   *
  ...
  /**
   * Returns the next child of the node鈥檚 parent.
   ...
   *
   * @param index The symbol number in the node鈥檚 string.
   * @return Symbol position in file.
   */
  positionInside(index: number): Node.Position

  /**
   * Returns the previous child of the node鈥檚 parent.
  ...
  /**
   * Finds the Root instance of the node鈥檚 tree.
   *
   * ```js
