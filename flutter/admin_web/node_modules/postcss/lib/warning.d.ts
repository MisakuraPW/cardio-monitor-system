...
/**
 * Represents a plugin鈥檚 warning. It can be created using `Node#warn`.
 *
 * ```js
 * if (decl.important) {
...
declare class Warning_ {
  /**
   * Column for inclusive start position in the input file with this warning鈥檚 source.
   *
   * ```js
   * warning.column //=> 6
   * ```
  ...
  /**
   * Column for exclusive end position in the input file with this warning鈥檚 source.
   *
   * ```js
   * warning.endColumn //=> 4
   * ```
  ...
  /**
   * Line for exclusive end position in the input file with this warning鈥檚 source.
   *
   * ```js
   * warning.endLine //=> 6
   * ```
  ...
  /**
   * Line for inclusive start position in the input file with this warning鈥檚 source.
   *
   * ```js
   * warning.line //=> 5
   * ```
