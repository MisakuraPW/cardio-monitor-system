...
declare namespace Container {
  ...
  export interface ValueOptions {
    /**
     * String that鈥檚 used to narrow down values and speed up the regexp search.
     */
    fast?: string
...
declare abstract class Container_<Child extends Node = ChildNode> extends Node {
  /**
   * An array containing the container鈥檚 children.
   *
   * ```js
  ...
  /**
   * Iterates through the container鈥檚 immediate children,
   * calling `callback` for each child.
   *
   * Returning `false` in the callback will break iteration.
   *
   * This method only iterates through the container鈥檚 immediate children.
   * If you need to recursively iterate through all the container鈥檚 descendant
   ...
   * for all of the container鈥檚 children.
   *
   * ```js
  ...
  /**
   * Returns a `child`鈥檚 index within the `Container#nodes` array.
   *
   * ```js
   ...
   *
   * @param oldNode Child or child鈥檚 index.
  ...
  /**
   * Traverses the container鈥檚 descendant nodes, calling callback
   ...
   * ```
   *
   * @param child Child or child鈥檚 index.
   * @return This node for methods chain.
   */
   ...
   *
   * If you only need to iterate through the container鈥檚 immediate children,
   * use `Container#each`.
   *
   * ```js
   * root.walk(node => {
