...
declare namespace AtRule {
  export interface AtRuleRaws extends Record<string, unknown> {
    ...
    /**
     * The rule鈥檚 selector with comments.
     */
    params?: {
      raw: string
      value: string
 ...
 * ```
 *
 * If it鈥檚 followed in the CSS by a `{}` block, this node will have
...
declare class AtRule_ extends Container {
  /**
   * An array containing the layer鈥檚 children.
   *
   * ```js
  ...
  type: 'atrule'
  /**
   * The at-rule鈥檚 name immediately follows the `@`.
   *
   * ```js
  ...
  /**
   * The at-rule鈥檚 parameters, the values that follow the at-rule鈥檚 name
