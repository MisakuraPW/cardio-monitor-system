...
> **Important:**<br>Please note that `escalade` only deals with direct ancestry 鈥?it will not dive into parents' sibling directories.
...
# Levels: 6 (target = "foo.txt"):
  find-up          x 24,856 ops/sec 卤6.46% (55 runs sampled)
  escalade         x 73,084 ops/sec 卤4.23% (73 runs sampled)
  find-up.sync     x  3,663 ops/sec 卤1.12% (83 runs sampled)
  escalade/sync    x  9,360 ops/sec 卤0.62% (88 runs sampled)

# Levels: 12 (target = "package.json"):
  find-up          x 29,300 ops/sec 卤10.68% (70 runs sampled)
  escalade         x 73,685 ops/sec 卤 5.66% (66 runs sampled)
  find-up.sync     x  1,707 ops/sec 卤 0.58% (91 runs sampled)
  escalade/sync    x  4,667 ops/sec 卤 0.68% (94 runs sampled)

# Levels: 18 (target = "missing123.txt"):
  find-up          x 21,818 ops/sec 卤17.37% (14 runs sampled)
  escalade         x 67,101 ops/sec 卤21.60% (20 runs sampled)
  find-up.sync     x  1,037 ops/sec 卤 2.86% (88 runs sampled)
  escalade/sync    x  1,248 ops/sec 卤 0.50% (93 runs sampled)
```
...
MIT 漏 [Luke Edwards](https://lukeed.com)
