...
export interface GeneratorOptions {
    ...
    /**
     * Set to true to run jsesc with "json": true to print "\u00A9" vs. "漏";
     */
    ...
    jsescOption?: {
         ...
         * environments is a concern, don鈥檛 enable this setting. If the json setting is enabled, the value for the es6
         ...
         * enabled, all the symbols in the output are escaped 鈥?even printable ASCII symbols.
         */
         ...
         * is escaped as \x3C!-- (or \u003C!-- when the json option is enabled). This setting is useful when jsesc鈥檚
         ...
         * the output for arrays and objects is as compact as possible; it鈥檚 not formatted nicely.
         */
         ...
         * overridden if needed 鈥?but in such cases, the output won鈥檛 be valid JSON anymore.
         */
