...
declare namespace React {
    ...
    /**
     * Lets you defer loading a component鈥檚 code until it is rendered for the first time.
     *
     ...
     * resolved value鈥檚 `.default` as a React component. Both the returned `Promise` and the `Promise`鈥檚
     ...
     *
     * Note that `useRef()` is useful for more than the `ref` attribute. It鈥檚 handy for keeping any mutable
     * value around similar to how you鈥檇 use instance fields in classes.
     *
     * @version 16.8.0
     ...
     *
     * If you鈥檙e migrating code from a class component, `useLayoutEffect` fires in the same phase as
     ...
     *
     * NOTE: We don鈥檛 recommend adding debug values to every custom hook.
     * It鈥檚 most valuable for custom hooks that are part of shared libraries.
     *
     * @version 16.8.0
    ...
    /**
     * Returns a deferred version of the value that may 鈥渓ag behind鈥?it.
     *
     ...
     *
     * The first is a boolean, React鈥檚 way of informing us whether we鈥檙e waiting for the transition to finish.
    ...
    /**
     * @deprecated Use `Validator` from the 麓prop-types` instead.
     */
    type Validator<T> = PropTypes.Validator<T>;

    /**
     * @deprecated Use `Requireable` from the 麓prop-types` instead.
     */
    type Requireable<T> = PropTypes.Requireable<T>;

    /**
     * @deprecated Use `ValidationMap` from the 麓prop-types` instead.
     */
    type ValidationMap<T> = PropTypes.ValidationMap<T>;

    /**
     * @deprecated Use `WeakValidationMap` from the 麓prop-types` instead.
     */
