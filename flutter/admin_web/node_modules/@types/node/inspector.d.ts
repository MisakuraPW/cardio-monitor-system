...
declare module "inspector" {
    ...
    namespace NetworkResources {
         ...
         * This is typically triggered when a source map is specified by URL, and a DevTools frontend鈥攕uch as
         * Chrome鈥攔equests the resource to retrieve the source map.
         *
