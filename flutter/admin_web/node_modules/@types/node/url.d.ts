...
declare module "url" {
     ...
     * import url from 'node:url';
     *
     * console.log(url.domainToASCII('espa帽ol.com'));
     * // Prints xn--espaol-zwa.com
     * console.log(url.domainToASCII('涓枃.com'));
     * // Prints xn--fiq228c.com
     * console.log(url.domainToASCII('xn--i帽valid.com'));
     ...
     * // Prints 涓枃.com
     * console.log(url.domainToUnicode('xn--i帽valid.com'));
     * // Prints an empty string
     * ```
     * @since v7.4.0, v6.13.0
     */
     ...
     *
     * new URL('file:///浣犲ソ.txt').pathname;      // Incorrect: /%E4%BD%A0%E5%A5%BD.txt
     * fileURLToPath('file:///浣犲ソ.txt');         // Correct:   /浣犲ソ.txt (POSIX)
     *
